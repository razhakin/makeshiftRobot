...
public class OI {
	...
	*/
	...
	public OI() {
		...
		aBut.whenPressed(new OpenHatchCommand());
		bBut.whenPressed(new CloseHatchCommand());
		xBut.whenPressed(new IntakeCommand());
		yBut.whenPressed(new StopIntakeCommand());
		povUp.whenPressed(new WinchOutCommand());
		povRight.whenPressed(new WinchInCommand());
		povLeft.whenPressed(new StopWinchCommand());
		povDown.whenPressed(new ShootCommand());
	}
}